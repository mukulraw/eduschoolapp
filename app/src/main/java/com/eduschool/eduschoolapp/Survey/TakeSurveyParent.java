...
*//*
                                ...
                                if (response.body().getSurveyListParent().equals("1")) {
    ...
    public static class Page extends Fragment {
                    ...
                    if (flag) {
                        ...
                        dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id1) {
                                ...
                                Call<UpdateSurveyBean> call = cr.update_qus(b.school_id, "Parent", b.user_id, surveyId, TextUtils.join(",", quesArray), TextUtils.join(",", ansArray));
        ...
        public void loadData() {
            if (Objects.equals(status, "Pending")) {
                ...
                Call<surveyAnsBean> call = cr.getAnswer("Parent", b.user_id, surveyId, id);
