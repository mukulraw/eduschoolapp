...
public class MarkAttndncDiffCls extends AppCompatActivity {
    ...
    String Sdate, Sdate1, month, year, day;
                ...
                try {
                    ...
                    if (response.body().getAttendanceList().size() > 0) {
                        if (response.body().getAttendanceList().get(0).getAttendanceData().size() > 0) {
                            ...
                            Call<studentLeaveBean> call3 = cr.student_leave_list(b.school_id, ClassID, sectionId, Sdate1);
                ...
                call3.enqueue(new Callback<MarkAttendanceBean>() {
                    ...
                    public void onResponse(Call<MarkAttendanceBean> call3, Response<MarkAttendanceBean> response) {
                        ...
                        if (response.body().getStatus().equals("1")) {
                            ...
                            Dialog dialog = new Dialog(MarkAttndncDiffCls.this);
                            ...
                            text.setText("Attendance for Class " + className + " Section " + sectionName + " has been submitted");
                            ...
                            dialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                                ...
                                public void onCancel(DialogInterface dialog) {
                                    ...
                                    i.putExtra("secName", sectionName);
                                    i.putExtra("secId", sectionId);
                            ...
                            Toast.makeText(MarkAttndncDiffCls.this, "Attendance already taken", Toast.LENGTH_SHORT).show();
                        }
