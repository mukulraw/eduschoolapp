...
public class UpdateOwnCls extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new updateAdapter(UpdateOwnCls.this, list);
            ...
            public void onResponse(Call<AttendanceListBean> call3, Response<AttendanceListBean> response) {
                ...
                try {
                    ...
                    else
                    {
                        ...
                        Toast.makeText(UpdateOwnCls.this , "No Data Found" , Toast.LENGTH_SHORT).show();
                    }
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d("update1" , TextUtils.join(",", studentId));
                Log.d("update2" , TextUtils.join(",", list1));
                    ...
                    public void onResponse(Call<UpdateAttendncBean> call3, Response<UpdateAttendncBean> response) {
                        ...
                        try {
                            if (response.body().getStatus().equals("1")){
                                ...
                                Toast.makeText(UpdateOwnCls.this,"Error updating attendance",Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        }catch (Exception e)
                        {
